<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold text-usepmaroon mb-4">Add School Information</h1>

        <div class="mb-6">
            <p class="text-gray-600">Use this form to add new school information to the system.</p>
        </div>
        ...
        <form class="space-y-4">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" class="px-4 py-2 bg-usepmaroon text-white rounded-md hover:bg-usepmaroon/90">Add School</button>
            </div>
        </form>
    </div>
</div>
