...
<div class="flex min-h-screen relative">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-usepmaroon text-white shadow-lg transform -translate-x-full md:translate-x-0 transition-slow flex flex-col z-50">
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-2 md:space-y-3 text-sm md:text-base">
            ...
            <a href="#" id="dashboardBtn" class="nav-item active flex items-center gap-3 px-3 py-2.5 md:py-3 rounded-lg hover:bg-usepmaroon/90 transition-slow">
            ...
            <div class="relative has-submenu">
                <a href="#" id="addMenuBtn" class="nav-item flex items-center justify-between px-3 py-2.5 md:py-3 rounded-lg hover:bg-usepmaroon/90 transition-slow">
                    <div class="flex items-center gap-3">
                ...
                <div class="submenu pl-4 space-y-1">
                    <a href="#" class="add-submenu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-usepmaroon/80 transition-slow" data-page="user">
                        <i class="fa-solid fa-user-plus w-5 text-center text-usepgold"></i>
                        <span class="nav-text text-sm font-medium">User</span>
                    </a>
                    <a href="#" class="add-submenu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-usepmaroon/80 transition-slow" data-page="school">
            ...
            <div class="relative has-submenu">
                <a href="#" id="updateMenuBtn" class="nav-item flex items-center justify-between px-3 py-2.5 md:py-3 rounded-lg hover:bg-usepmaroon/90 transition-slow">
                    <div class="flex items-center gap-3">
                ...
                <div class="submenu pl-4 space-y-1">
                    <a href="#" class="update-submenu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-usepmaroon/80 transition-slow" data-page="updateUser">
                        <i class="fa-solid fa-user-pen w-5 text-center text-usepgold"></i>
                        <span class="nav-text text-sm font-medium">Update User</span>
                    </a>
                    <a href="#" class="update-submenu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-usepmaroon/80 transition-slow" data-page="updateSchoolInfo">
            ...
            <div class="relative has-submenu">
                <a href="#" id="accountsMenuBtn" class="nav-item flex items-center justify-between px-3 py-2.5 md:py-3 rounded-lg hover:bg-usepmaroon/90 transition-slow">
                    <div class="flex items-center gap-3">
                ...
                <div class="submenu pl-4 space-y-1">
                    <a href="#" class="accounts-submenu-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-usepmaroon/80 transition-slow" data-page="manageAccounts">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="relative">
                    <div id="profile-trigger" class="flex items-center gap-2 cursor-pointer">
                        <img src="{{ asset('images/usep-logo-small.png') }}" alt="User" class="w-8 h-8 rounded-full border-2 border-white shadow"/>
                        <span class="hidden md:block font-medium text-usepmaroon">Robert</span>
                    ...
                    <div id="profile-dropdown" class="profile-dropdown absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-usepgold/20 hover:text-usepmaroon transition-slow" onclick="loadAccountSettings()">
                            <i class="fa-solid fa-user-cog mr-2"></i> Account Settings
                        </a>
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-usepgold/20 hover:text-usepmaroon transition-slow" onclick="loadHistory()">
